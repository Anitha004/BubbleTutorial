...
import com.example.bubbleapplication.databinding.MessageItemBinding
    ...
    override fun onBindViewHolder(holder: MessageViewHolder, position: Int) {
        ...
        if (message.isIncoming) {
            holder.binding.message.run {
                setBackgroundResource(R.drawable.incoming_msg)
            ...
            holder.binding.message.run {
                setBackgroundResource(R.drawable.outgoing_msg)
